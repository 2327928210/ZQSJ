...
public class FindHeadViewActivity3 extends Activity {
    ...
    private String url= Constants.Discover_find_head_2ji3;
    ...
    protected void onDestroy() {
        ...
        Volley.newRequestQueue(this).cancelAll("request3");
    }
}