package com.example.haier.sheji.homepager.ShengHuo;
...
import static com.example.haier.sheji.url.MyUrl.Home_Entertainmen_Fast1;

/**
 * A simple {@link Fragment} subclass.
 */
public class ShengHuoFragment extends Fragment implements View.OnClickListener{
...
//                                nextpage.add(nextPageBean);
                                url1 =  Home_Entertainmen_Fast1+nexttime+MyUrl.Home_Life_Fast2+nextsign+MyUrl.Home_Entertainmen_Fast3;
                                //-----下一页数据-----
...
//                                nextpage.add(nextPageBean);
                                ...
                                nexttime = jsondata.getString("nexttime");
                                nextsign = jsondata.getString("nextsign");
                                url1 = MyUrl.Home_Entertainmen_Fast1+nexttime+MyUrl.Home_Life_Fast2+nextsign+MyUrl.Home_Entertainmen_Fast3;
                                //------------6666-------------------------------------------------------------
                                isLoading = false;
                                //------------6666-------------------------------------------------------------
                            } catch (JSONException e) {
