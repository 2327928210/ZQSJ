package com.example.haier.sheji.homepager.qiqu;
 ...
 */
public class QiQuFragment extends Fragment implements View.OnClickListener{
    ...
    public void VollsyRequest( int page) {
        if (page == 1) {
            ...
            StringRequest stringRequest = new StringRequest(StringRequest.Method.GET,
                    Constants.Home_Interesting_Fast+page,
...
//                                nextpage.add(nextPageBean);
                                url1 = MyUrl.Home_Interesting_Fast1+nexttime+MyUrl.Home_Interesting_Fast2+nextsign+MyUrl.Home_Interesting_Fast3;
                                //-----下一页数据-----
