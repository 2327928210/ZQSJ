package com.example.haier.sheji.homepager.yule;
...
import static com.example.haier.sheji.url.MyUrl.Home_Entertainmen_Fast3;
    ...
    public void VollsyRequest( int page) {
        if (page == 1) {
            ...
            StringRequest stringRequest = new StringRequest(StringRequest.Method.GET,
                    Constants.Home_Entertainmen_Fast+page,
...
//                                nextpage.add(nextPageBean);
                                url1 = MyUrl.Home_Entertainmen_Fast1+nexttime+MyUrl.Home_Entertainmen_Fast2+nextsign+ Home_Entertainmen_Fast3;
                                //-----下一页数据-----
